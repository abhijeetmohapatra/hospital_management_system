...
#for showing signup/login button for admin(by abhijeet)
...
#for showing signup/login button for doctor(by abhijeet)
...
#for showing signup/login button for patient(by abhijeet)
